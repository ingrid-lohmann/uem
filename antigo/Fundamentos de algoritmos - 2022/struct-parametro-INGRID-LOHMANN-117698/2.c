...
/*
  ...
  Processamento: passa o valor da struct para uma função de cadastro e depois imprimir o que foi digitado utilizando outra função;
*/
...
void imprime(struct cadastro c) {
  printf("\nNome: %s", c.nome);
  printf("\nRA: %i\n", c.ra);
